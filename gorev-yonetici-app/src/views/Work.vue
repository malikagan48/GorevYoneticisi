    ...
    <ion-page>
        ...
        <ion-content class="overflow-auto">
            <div class="flex flex-col justify-center items-center mt-2">
                ...
                <div class="text-center">
                    <ion-card-title>İş Görevleri</ion-card-title>
                </div>
            </div>
            <div>
                <ion-list>
...
export default defineComponent({
    ...
    setup () {
        ...
        const state: any=reactive({
            ...
            isGorev:computed(()=>{
                return store.getters.kategoriyeGoreGorevGetir('İş');
            }),
            gelen:computed(()=>{
                return store.getters.gelen(state.isGorev);
            }),
            bugun:computed(()=>{
                return store.getters.bugun(state.isGorev);
            }),
            yapilan:computed(()=>{
                return store.getters.yapilan(state.isGorev);
            }),
            gecen:computed(()=>{
                return store.getters.gecen(state.isGorev);
            }),
        })
        ...
        return {ellipsisVertical,briefcase,trash,state,gorevTamamla,gorevTamamlama,gorevSil}
    }
})
</script>
