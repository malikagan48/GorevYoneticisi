    ...
    <ion-page>
        ...
        <ion-content class="overflow-auto">
            <div class="flex flex-col justify-center items-center mt-2">
                ...
                <div class="text-center">
                    <ion-card-title>Müzik Görevleri</ion-card-title>
                </div>
            </div>
            <div>
                <ion-list>
...
export default defineComponent({
    ...
    setup () {
        ...
        const state: any=reactive({
            ...
            muzikGorev:computed(()=>{
                return store.getters.kategoriyeGoreGorevGetir('Müzik');
            }),
            gelen:computed(()=>{
                return store.getters.gelen(state.muzikGorev);
            }),
            bugun:computed(()=>{
                return store.getters.bugun(state.muzikGorev);
            }),
            yapilan:computed(()=>{
                return store.getters.yapilan(state.muzikGorev);
            }),
            gecen:computed(()=>{
                return store.getters.gecen(state.muzikGorev);
            }),
        })
        ...
        return {ellipsisVertical,headset,trash,state,gorevTamamla,gorevTamamlama,gorevSil}
    }
})
</script>
