        ...
        <ion-content class="overflow-auto">
            <div class="flex flex-col justify-center items-center mt-2">
                <div class="text-center">
                    <ion-icon :icon="footballSharp" size="large" class="text-purple-400"></ion-icon>
                </div>
                <div class="text-center">
                    <ion-card-title>Spor Görevleri</ion-card-title>
                </div>
            </div>
            <div>
                <ion-list>
...
export default defineComponent({
    ...
    setup () {
        ...
        const state: any=reactive({
            ...
            sporGorev:computed(()=>{
                return store.getters.kategoriyeGoreGorevGetir('Spor');
            }),
            gelen:computed(()=>{
                return store.getters.gelen(state.sporGorev);
            }),
            bugun:computed(()=>{
                return store.getters.bugun(state.sporGorev);
            }),
            yapilan:computed(()=>{
                return store.getters.yapilan(state.sporGorev);
            }),
            gecen:computed(()=>{
                return store.getters.gecen(state.sporGorev);
            }),
        })
        ...
        return {ellipsisVertical,footballSharp,trash,state,gorevTamamla,gorevTamamlama,gorevSil}
    }
})
</script>
